...
func start(b *Bot, message *tgbotapi.Message) (err error) {
...
func hello(b *Bot, message *tgbotapi.Message) (err error) {
...
func courses(b *Bot, message *tgbotapi.Message) error {
